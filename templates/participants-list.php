                ...
                <tr class="hover:bg-gray-50 transition-colors relative hover:z-20">
                    ...
                    <td class="px-6 py-4">
                        <span class="px-2.5 py-1 rounded-full text-xs font-bold shadow-sm 
                            <?= $user['join_status'] === 'approved' ? 'bg-green-100 text-green-700 border border-green-200' : 
                               ($user['join_status'] === 'rejected' ? 'bg-red-100 text-red-700 border border-red-200' : 
                    ...
                    <td class="px-6 py-4 text-center relative">
                        <div class="inline-block text-left">
                            <button 
                                ...
                                <?= $user['join_status'] === 'approved' ? 'bg-green-50 text-green-700 border-green-200 hover:bg-green-100' : 
                                   ($user['join_status'] === 'rejected' ? 'bg-red-50 text-red-700 border-red-200 hover:bg-red-100' : 
